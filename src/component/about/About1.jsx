      ...
      <div className='max-w-7xl px-4 py-16 mx-auto'>
        <div className='grid grid-cols-1 md:grid-cols-2 min:h-[600px] w-full gap-8'>
            ...
            <div className='mt-6 flex flex-col items-start text-black/60 w-[80%]'>
                <h3 className='text-3xl md:text-3xl xl:text-4xl font-bold text-[#97755A]'>We Are The Best RealEstate Company</h3>
                ...
                <button className='mt-8 xl:mt-12 bg-[#97755A] text-white px-4 py-1.5 rounded-full'>
                  Learn More
                </button>
            </div>
        </div>
