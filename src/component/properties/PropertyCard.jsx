        ...
        <div className='group-hover:-translate-y-[16px] transform duration-500'>
          ...
          <div className='p-4'>
            <div className='flex items-center gap-2'>
              <FaMapLocation className='text-[#97755A] text-[28px]' />
            ...
            <div className='flex items-center justify-between'>
              ...
              {/* <p className='text-red-600 font-bold text-xl'>        $ {props.property.price}
            {props.property.type === 'rent' && <span className='text-[14px] text-black/50'>/month</span>}
          </p> */}
            </div>
